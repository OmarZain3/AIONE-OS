...
Prioritized work items for AIONE. Governed by [ADR
0001](../docs/adr/0001-repository-strategy.md) (monorepo), [ADR
0002](../docs/adr/0002-flutter-architecture.md), [ADR
0003](../docs/adr/0003-django-architecture.md), [ADR
0004](../docs/adr/0004-generator-driven-development.md), and [ADR
...
| BL-014 | founder_studio clean architecture | P0 | Done | ADR 0002 |
| BL-015 | Client auth (login, tokens, storage) | P1 | Done | ADR 0002 |
| BL-016 | Client health + connection status | P1 | Done | ADR 0002 |
| BL-017 | Flutter Dockerfile + Compose integration | P1 | Done | ADR 0002 |
| BL-018 | Cross-stack E2E smoke test (`tests/`) | P1 | Open | ADR 0001 |
| BL-019 | Reconcile README and CHANGELOG | P1 | Open | versioning |
| BL-020 | founder_studio README update | P2 | Open | ADR 0002 |
...
| ID | Item | Priority | Status | ADR / Standard |
| -- | ---- | -------- | ------ | -------------- |
| BL-030 | definitions/ (OpenAPI, models) | P1 | Open | ADR 0004 |
...
| BL-033 | CI drift check (defs vs output) | P1 | Open | ADR 0004 |
| BL-034 | Migrate auth/health to generated contracts | P2 | Open | ADR 0004 |
...
| BL-042 | Register app and service graph nodes | P2 | Open | ADR 0005 |
| BL-043 | Auto-discovery (Phase 3) | P3 | Open | ADR 0005 |

### E5 — Shared Packages

| ID | Item | Priority | Status | ADR / Standard |
| -- | ---- | -------- | ------ | -------------- |
| BL-050 | packages/ layout policy | P2 | Open | ADR 0001, 0004 |
| BL-051 | Shared API client package | P2 | Open | ADR 0002, 0004 |
...
| BL-062 | Observability baseline (structured logging, … | P2 | Open | ADR 0003 |
...
- User-facing changes require `CHANGELOG.md` entry per
