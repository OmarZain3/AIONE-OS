...
[docs/standards/versioning.md](docs/standards/versioning.md) for release
history.
...
For **v0.1.0-alpha**, report via [GitHub Security
Advisories](https://github.com/aione/aione/security/advisories/new) on this
repository (preferred) or email **<security@aione.dev>**.
...
- Follow the [code review checklist](docs/standards/code_review_checklist.md)
...
Out of scope: third-party services, social engineering, and issues in
